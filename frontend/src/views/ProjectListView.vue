<template>
  <section class="page projects-page">
    <section class="project-toolbar surface-panel" aria-label="项目筛选">
...
<style scoped>
.project-toolbar, .project-mobile-row { display: flex; align-items: center; justify-content: space-between; gap: 16px; }
.project-toolbar { display: grid; grid-template-columns: minmax(240px, 1fr) 160px 140px auto; margin-bottom: 16px; padding: 14px; }.project-loading { padding: 24px; }.project-table-wrap { border: 1px solid var(--color-border); border-radius: var(--radius-lg); overflow: hidden; background: var(--color-surface); box-shadow: var(--shadow-card); }.project-table strong, .project-table__sub { display: block; }.project-table__sub { margin-top: 3px; color: var(--color-text-muted); font-size: 11px; }.project-table-footer { padding: 12px 16px; border-top: 1px solid var(--color-border); color: var(--color-text-muted); font-size: 12px; }.project-mobile-list { display: none; }
