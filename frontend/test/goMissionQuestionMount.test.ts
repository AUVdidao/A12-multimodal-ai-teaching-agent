...
const readyTemplateBinding = { bindingKind: 'LESSONFORGE_UPSTREAM_TEMPLATE_BINDING', missionId: 7, missionFileId: 11, fileObjectId: 12, ownerUserId: 7, templateStorageKey: 'templates/teacher.pptx', templateFileSha256: '1234567890123456789012345678901234567890123456789012345678901234', templateOriginalName: '教师模板.pptx' };
